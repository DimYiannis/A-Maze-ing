...
THEMES: list[Theme] = [
    ...
    Theme("Brown",  (30,  28,  35),  (100,  80,  60), (140, 115,  88)),
    Theme("Blue",   (20,  30,  45),  (140, 175, 210), (200, 225, 245)),
    Theme("Orange", (25,  15,  10),  (160,  70,  20), (220, 120,  40)),
    Theme("Green",  (20,  28,  18),  ( 70, 105,  55), (105, 145,  80)),
]
